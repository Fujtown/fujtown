(function($) {
    ...
    $(".change-price-plan li a").on("click", function (e) {
        ...
        if (type == "monthly") {
            $(".text-duration").html("Month");
            $(".text-price-small").html("AED 15");
           
            $(".text-price-standard").html("AED 25");
            // $(".text-type-standard").html("- user / month");
            $(".text-price-business").html("AED 35");
            // $(".text-type-business").html("- user / month");
            $(".text-price-enterprise").html("AED 55");
            // $(".text-type-enterprise").html("- user / month");
        } else {
            $(".text-duration").html("Year");
            $(".text-price-small").html("AED 180");
            $(".text-price-standard").html("AED 300");
            // $(".text-type-standard").html("- user / year");
            $(".text-price-business").html("AED 500");
            // $(".text-type-business").html("- user / year");
            $(".text-price-enterprise").html("AED 600");
