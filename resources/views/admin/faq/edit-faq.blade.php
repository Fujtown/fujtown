        ...
        <div class="col-lg-3"></div>
                    ...
                    <div class="card">
                        <div class="card-body bootstrap-select-1">
                            ...
                            <p class="text-muted mb-4 font-13">Edit FAQ . </p>
                            @if(session('success'))
                        ...
                        @endif
                            ...
                            <form action="{{route('coffee.update-faq',$faq->id)}}"  method="POST">
                                @csrf
                                @method('PUT')
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select name="category" class="form-control" id="">
                                        ...
                                        @foreach($fcat as $cat)
                                        <option value="{{$cat->id}}" {{ $cat->id==$faq->faq_cat_id ? 'selected':'' }} >{{$cat->name}}</option>
                                        @endforeach
                                    </select>
                                </div>                                    
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="description" id="elm1">{{$faq->description}}</textarea>
                                </div>                                    
