        ...
        <div class="col-lg-3"></div>
                    ...
                    <div class="card">
                        <div class="card-body bootstrap-select-1">
                            <h4 class="mt-0 header-title">Blog Category</h4>
                            <p class="text-muted mb-4 font-13">Add Blog Category. </p>
                            @if(session('success'))
                        ...
                        @endif
                            ...
                            <form action="{{route('coffee.store-blogcategory')}}" enctype="multipart/form-data" method="POST">
                                @csrf
                            <div class="row">
                                <div class="col-md-12">
