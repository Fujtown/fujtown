    ...
    <div class="row">
        <div class="col-lg-1"></div>
                    ...
                    <div class="card">
                        ...
                        <form action="{{route('coffee.update-news',$news->id)}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('PUT')
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="col-md-2">
                                    <div class="mt-2">
                                    <img src="{{ asset('storage/' . $news->img_src) }}" alt="{{ $news->title }}" style="width: 100px; height: auto;">
                                </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea id="elm1" name="description">  {!! $news->description !!}</textarea>
                                </div>
