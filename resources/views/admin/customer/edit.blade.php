    ...
    <div class="row">
                    ...
                    <div class="card">
                        ...
                        @endif
                            ...
                            <form action="{{route('coffee.update-customer',$customer->id)}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" value="{{$customer->customer_user_name}}" name="customer_user_name" class="form-control" /> 
                                </div>                                    
                                <div class="col-md-6">
                                    <h6 class=" input-title mb-2 mt-10">Phone</h6>                                            
                                    <input type="text" value="{{$customer->customer_phone}}" name="customer_phone" class="form-control" /> 
                                </div>                                    
                                <div class="col-md-6">
