        ...
        <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <tr>
                                            ...
                                            <td>                                                       
                                        <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#editModal" data-id="{{ $pcat->id }}" data-name="{{ $pcat->parent_category_name }}" data-name-arabic="{{ $pcat->parent_category_name_arabic }}" data-thumb="{{ asset('storage/' . $pcat->parent_category_thumb) }}">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-danger" onclick="confirmDelete(`{{ $pcat->id }}`)">
                                            <i class="fas fa-trash-alt"></i>
                                        </button>
                                        <form id="delete-form-{{ $pcat->id }}" action="{{ route('coffee.delete-parent-category', $pcat->id) }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
